...
<template>
  <div class="config-panel">
    ...
    <div class="config-actions">
      <button @click="saveConfig" class="action-btn save">保存配置</button>
      <button @click="loadConfig" class="action-btn load">加载配置</button>
      <button @click="resetConfig" class="action-btn reset">恢复默认</button>
    </div>
  </div>
</template>
